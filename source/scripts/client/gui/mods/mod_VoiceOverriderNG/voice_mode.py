...
VOICE_MODES = [
    VoiceMode('nothing', synthetic=True, icon='empty'),
    VoiceMode('mute', synthetic=True, icon='empty'),
    ...
    VoiceMode('sequential', synthetic=True, icon='empty'),
    VoiceMode('default', 'default', icon='empty'),
    ...
    VoiceMode('valkyrie_male', 'valkyrie2', lang='JA', icon='japan_Welkin_Gunther', enabled=False),
    VoiceMode('valkyrie_female', 'valkyrie1', lang='JA', female=True, icon='japan_Carisa_Contzen', enabled=False),
    ...
    VoiceMode('20_Mailand', 'eu1_Mailand', lang='DE', icon='bob20_commander1_eu', icon_ny='crewSkins/ny25_blogger04', icon_bd='crewSkins/bertdaymailand'),
    VoiceMode('20_Skill4ltu', 'eu2_Skill4ltu', lang='RU', icon='bob20_commander2_eu', icon_ny='crewSkins/ny25_blogger01', icon_bd='crewSkins/birthdayskill4ltu'),
    VoiceMode('20_Dezgamez', 'eu3_Dezgamez', icon='bob20_commander3_eu', icon_ny='crewSkins/ny25_blogger06', icon_bd='crewSkins/afterpartydezgamez'),
    VoiceMode('20_AwesomeEpicGuys', 'eu4_AwesomeEpicGuys', lang='SV', icon='bob20_commander4_eu', icon_ny='crewSkins/ny25_blogger05', icon_bd='crewSkins/coolcumberguys'),
    ...
    VoiceMode('21_Dakillzor', 'bb21_eu2_Dakillzor', lang='FR', icon='bob21_blogger2_eu', icon_ny='crewSkins/ny25_blogger07', icon_bd='crewSkins/birthdaydakillzor'),
    VoiceMode('21_Newmulti2k', 'bb21_eu3_Newmulti2k', lang='PL', icon='bob21_blogger3_eu', icon_ny='crewSkins/ny25_blogger09', icon_bd='crewSkins/birthdaynewmultishow'),
    VoiceMode('21_Orzanel', 'bb21_eu4_Orzanel', icon='bob21_blogger4_eu', icon_ny='crewSkins/ny25_blogger10', icon_bd='crewSkins/blingblingorzy'),
    ...
    VoiceMode('quickyBaby', 'quickyBaby', lang='UK', icon='commander_quickybaby', icon_ny='crewSkins/ny25_blogger03', icon_bd='crewSkins/birthdaykingbaby'),
    ...
    VoiceMode('talktomeGoose', 'talktomeGoose', lang='EN', icon='tc2023_commander_1', icon_ny='crewSkins/ny25_blogger02', icon_bd='crewSkins/birthdaytalktomegoose'),
    VoiceMode('skill4ltu_23', 'skill4ltu_23', lang='RU', icon='tc2023_commander_2', icon_ny='crewSkins/ny25_blogger01', icon_bd='crewSkins/birthdayskill4ltu'),
    VoiceMode('tankman_bp_12_m_5', 'tankman_bp_12_m_5', female=True, icon='tankmen_bp12_5'),
    VoiceMode('tankman_bp_12_m_8', 'tankman_bp_12_m_8', icon='tankmen_bp12_8'),
    VoiceMode('tankman_bp_12_m_9', 'tankman_bp_12_m_9', icon='tankmen_bp12_9'),
    VoiceMode('tankman_bp_12_m_10', 'tankman_bp_12_m_10', female=True, icon='tankmen_bp1003_1', enabled=False),
    VoiceMode('tankmen_bp1002_1', 'tankmen_bp1002_1', lang='RU', icon=True),
    VoiceMode('tankmen_bp1002_3', 'tankmen_bp1002_3', lang='UK', icon=True),
    VoiceMode('tankmen_bp1004_1', 'tankmen_bp1004_1', lang='EN', icon=True),
    VoiceMode('tankmen_bp1004_2', 'tankmen_bp1004_2', lang='EN', icon=True),
    VoiceMode('tankmen_bp1004_3', 'tankmen_bp1004_3', lang='EN', icon=True),
    VoiceMode('tankmen_bp1004_4', 'tankmen_bp1004_4', lang='EN', icon=True),
    VoiceMode('tankmen_bp1004_5', 'tankmen_bp1004_5', female=True, icon=True),
    VoiceMode('tankmen_bp1005_1', 'tankmen_bp1005_1', lang='EN', icon=True),
    VoiceMode('tankmen_bp1005_2', 'tankmen_bp1005_2', lang='EN', icon=True),
    VoiceMode('tankmen_bp1006_1', 'tankmen_bp1006_1', lang='EN', icon=True),
    VoiceMode('tankmen_bp1006_2', 'tankmen_bp1006_2', lang='EN', icon=True),
    VoiceMode('tankmen_bp1006_3', 'tankmen_bp1006_3', lang='EN', icon=True),
    VoiceMode('tankmen_bp1006_4', 'tankmen_bp1006_4', lang='EN', icon=True),
    VoiceMode('tankmen_bp1006_5', 'tankmen_bp1006_5', lang='EN', female=True, icon=True),
    VoiceMode('tankmen_bp1006_6', 'tankmen_bp1006_6', lang='EN', icon=True),
    ...
    VoiceMode('celebrity2026_en', 'celebrity2026_en', lang='UK', icon='ny26_men'),
    VoiceMode('tankmen_bp13_1', 'tankmen_bp13_1', icon=True),
    VoiceMode('tankmen_bp13_2', 'tankmen_bp13_2', icon=True),
    VoiceMode('tankmen_bp13_3', 'tankmen_bp13_3', icon=True),
    VoiceMode('tankmen_bp13_4', 'tankmen_bp13_4', icon=True),
    VoiceMode('tankmen_bp13_5', 'tankmen_bp13_5', icon=True),
    VoiceMode('tankmen_bp13_6', 'tankmen_bp13_6', icon=True),
    VoiceMode('tankmen_bp13_7', 'tankmen_bp13_7', icon=True),
    VoiceMode('tankmen_bp13_8', 'tankmen_bp13_8', icon=True),
    VoiceMode('tankmen_bp13_9', 'tankmen_bp13_9', female=True, icon=True),
    VoiceMode('tankmen_bp14_5', 'tankmen_bp14_5', lang='UK', icon=True),
    VoiceMode('tankmen_bp14_6', 'tankmen_bp14_6', lang='UK', icon=True, icon_ny='crewSkins/ny25_blogger13'),
    VoiceMode('tankmen_bp15_5', 'tankmen_bp15_5', lang='SV', icon=True),
    VoiceMode('tankmen_bp15_6', 'tankmen_bp15_6', lang='SV', icon=True),
    VoiceMode('tankmen_bp15_7', 'tankmen_bp15_7', lang='SV', icon=True),
    VoiceMode('tankmen_bp15_8', 'tankmen_bp15_8', lang='SV', female=True, icon=True),
    VoiceMode('tankmen_bp15_9', 'tankmen_bp15_9', lang='SV', icon=True),
    VoiceMode('tankmen_bp16_5', 'tankmen_bp16_5', lang='UK', icon=True),
    VoiceMode('tankmen_bp16_6', 'tankmen_bp16_6', lang='UK', icon=True),
    VoiceMode('tankmen_bp16_7', 'tankmen_bp16_7', lang='UK', icon=True),
    VoiceMode('tankmen_bp16_8', 'tankmen_bp16_8', lang='UK', female=True, icon=True),
    VoiceMode('tankmen_bp16_9', 'tankmen_bp16_9', lang='UK', icon=True),
    VoiceMode('tankmen_bp17_5', 'tankmen_bp17_5', lang='EN', icon=True),
    VoiceMode('tankmen_bp17_8', 'tankmen_bp17_8', lang='UK', female=True, icon=True),
    VoiceMode('tankmen_bp18_5', 'tankmen_bp18_5', lang='EN', icon=True),
    VoiceMode('tankmen_bp18_6', 'tankmen_bp18_6', lang='DE', female=True, icon=True),
    VoiceMode('tankmen_bp18_7', 'tankmen_bp18_7', lang='DE', icon=True),
    VoiceMode('tankmen_bp18_8', 'tankmen_bp18_8', lang='PL', female=True, icon=True),
    VoiceMode('tankmen_bp18_9', 'tankmen_bp18_9', lang='DE', female=True, icon=True),
    VoiceMode('tankmen_bp18_10', 'tankmen_bp18_10', lang='EN', icon=True),
    VoiceMode('tankmen_bp18_11', 'tankmen_bp18_11', lang='EN', icon=True),
    VoiceMode('tankmen_bp18_12', 'tankmen_bp18_12', lang='EN', icon=True),
    VoiceMode('tankmen_bp18_13', 'tankmen_bp18_13', lang='EN', female=True, icon=True),
    VoiceMode('tankmen_bp18_14', 'tankmen_bp18_14', lang='EN', icon=True),
    VoiceMode('tankmen_bp19_5', 'tankmen_bp19_5', lang='EN', icon=True),
    VoiceMode('tankmen_bp19_6', 'tankmen_bp19_6', lang='EN', icon=True),
    VoiceMode('tankmen_bp19_7', 'tankmen_bp19_7', lang='EN', icon=True),
    VoiceMode('tankmen_bp19_8', 'tankmen_bp19_8', lang='EN', icon=True),
    VoiceMode('tankmen_bp19_9', 'tankmen_bp19_9', lang='EN', icon=True),
    VoiceMode('tankmen_bp20_5', 'tankmen_bp20_5', lang='EN', icon=True),
    VoiceMode('tankmen_bp20_6', 'tankmen_bp20_6', lang='EN', icon=True),
    VoiceMode('tankmen_bp20_7', 'tankmen_bp20_7', lang='EN', icon=True),
    ...
    VoiceMode('gup_mika', 'gup_mika', female=True, icon='girls_und_panzer_mika'),
    VoiceMode('gup_crew_24', 'gup_crew_24', female=True, icon=['girls_und_panzer_aki', 'girls_und_panzer_mikko']),
    VoiceMode('gup_alice', 'gup_alice', lang='UK', female=True, icon='girls_und_panzer_alice'),
    ...
    VoiceMode('gup_crew_hippo_en', 'gup_crew_hippo_en', lang='DE', female=True, icon=['girls_und_panzer_erwin', 'girls_und_panzer_caesar', 'girls_und_panzer_saemonza', 'girls_und_panzer_oryou']),
    VoiceMode('gup_erwin_en', 'gup_erwin_en', lang='DE', female=True, icon='girls_und_panzer_erwin'),
    VoiceMode('gup_crew_hippo_cn', 'gup_crew_hippo_cn', lang='ZH_CH', female=True, icon=['girls_und_panzer_erwin', 'girls_und_panzer_caesar', 'girls_und_panzer_saemonza', 'girls_und_panzer_oryou']),
    VoiceMode('gup_erwin_cn', 'gup_erwin_cn', lang='ZH_CH', female=True, icon='girls_und_panzer_erwin'),
    ...
    VoiceMode('mouzAkrobat24', 'mouzAkrobat24', lang='DE', icon='wt_2024_mouzakrobat', icon_ny='crewSkins/ny25_blogger14', icon_bd='crewSkins/birthdaymouzakrobat'),
    VoiceMode('quickyBaby24', 'quickyBaby24', lang='UK', icon='wt_2024_quickybaby', icon_ny='crewSkins/ny25_blogger03', icon_bd='crewSkins/birthdaykingbaby'),
    VoiceMode('dakillzor24', 'dakillzor24', lang='FR', icon='wt_2024_dakillzor', icon_ny='crewSkins/ny25_blogger07', icon_bd='crewSkins/birthdaydakillzor'),
    VoiceMode('skill4ltu24', 'skill4ltu24', lang='RU', icon='wt_2024_skill4ltu', icon_ny='crewSkins/ny25_blogger01', icon_bd='crewSkins/birthdayskill4ltu'),
    ...
    VoiceMode('hw25_Mailand_de', 'hw25_Mailand_de', lang='DE', icon='hw25_Mailand', icon_ny='crewSkins/ny25_blogger04', icon_bd='crewSkins/bertdaymailand'),
    VoiceMode('hw25_MouzAkrobat_de', 'hw25_MouzAkrobat_de', lang='DE', icon='hw25_MouzAkrobat', icon_ny='crewSkins/ny25_blogger14', icon_bd='crewSkins/birthdaymouzakrobat'),
    VoiceMode('hw25_Quickybaby_en', 'hw25_Quickybaby_en', lang='UK', icon='hw25_Quickybaby', icon_ny='crewSkins/ny25_blogger03', icon_bd='crewSkins/birthdaykingbaby'),
    VoiceMode('hw25_Skill4ltu_en', 'hw25_Skill4ltu_en', lang='RU', icon='hw25_Skill4ltu', icon_ny='crewSkins/ny25_blogger01', icon_bd='crewSkins/birthdayskill4ltu'),
